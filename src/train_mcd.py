...
def train_net(net_g,
    ...
    if last_epoch != 0 and os.path.exists(path_lossList):
        ...
        tr_s_loss_list = last_data['tr_s_loss_list']
        tr_d_loss_list = last_data['tr_d_loss_list']
        val_d_loss_list = last_data['val_d_loss_list']

        with open(os.path.join(dir_checkpoint, f'last_epoch.json'), 'r') as f:
            last_log = json.load(f)
            min_val_d_loss = last_log['min_val_d_loss']
    ...
    for epoch in range(last_epoch, epochs):
        ...
        for i, (bs, bt) in enumerate(zip(batch(train_s, batch_size, source), batch(train_t, batch_size, source))):
            ...
            if (i + 1) % 10 == 0:
                ...
                print('epoch : {}, iter : {}, seg_loss : {}, dis_loss :{}'.format(epoch + 1, i, s_epoch_loss_iter,
                      d_epoch_loss_iter))
        ...
        my_dict = {'tr_s_loss_list': tr_s_loss_list, 'tr_d_loss_list': tr_d_loss_list,
                   'val_d_loss_list': val_d_loss_list}
        ...
        last_ckpt = {
            ...
            'net_s1': net_s1.state_dict(),
            'net_s2': net_s2.state_dict(),
            'opt_g': opt_g.state_dict(),
            'opt_s1': opt_s1.state_dict(),
            'opt_s2': opt_s2.state_dict(),
        }
        ...
        save_data_for_last['min_val_d_loss'] = min_val_d_loss
    ...
    # target iou graph
    draw_graph(dir_graphs, 'target_IoU', epochs, red_list=val_iou_t1_list, red_label='t1_IoU',
               green_list=val_iou_t2_list, green_label='t2_IoU', y_label='IoU')
...
def get_args():
    ...
    parser.add_argument('-checkpoint', '--checkpoint', metavar='CT', type=str, nargs='?', default=None,
...
if __name__ == '__main__':
    ...
    if args.raw_mode == False:
        ...
        if args.checkpoint != None:
            ...
            net_s1.load_state_dict(checkPoint['net_s1'])
            net_s2.load_state_dict(checkPoint['net_s2'])
