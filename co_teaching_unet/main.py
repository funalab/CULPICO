...
def train_net(net_1,
    ...
    #print(f'epochs:{exponent}')
    #print(f'forget_rate:{forget_rate}')
    #print(f'exponent:{exponent}')
    #print(f'num_gradual:{num_gradual}')
    ...
    for epoch in range(epochs):
        ...
        for i, bt in enumerate( batch(train_t, batch_size, source) ):
            ...
            if co_teaching:
                loss_1, loss_2 = loss_coteaching(mask_prob_1, mask_prob_2, pseudo_bin.detach(), rate_schedule[epoch], len(pseudo_bin), device)
            else:
            ...
            count += 1
            if i != 0:
                print('epoch : {}, iter : {}, loss_1 : {}, loss_2:{}, rtsk:{}'.format( epoch+1, i, epoch_loss_1/i, epoch_loss_2/i, rate_schedule[epoch]  ) )
        # epoch loss (seg & dis)
        ...
        my_dict = { 'tr_s_loss_list_1': tr_s_loss_list_1, 'tr_s_loss_list_2': tr_s_loss_list_2  }
