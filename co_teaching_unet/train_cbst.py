...
def train_net(net_1,
    ...
    with torch.no_grad():
        for k, bt in enumerate(val_t):
            ...
            pl_iou = val_iou_t1 / len_val_t
    
    with open(path_w, mode='a') as f:
            f.write(f'\n --- step{step}: target label IoU =  {pl_iou} ---\n')
    ...
    for epoch in range(epochs):
        ...
        my_dict = { 'tr_s_loss_list_1': tr_s_loss_list_1,  'source_seg_list_1': source_seg_list_1,  'tgt_seg_list_1':tgt_seg_list_1, 'pl_iou':pl_iou  }
